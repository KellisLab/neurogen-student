...
system("gsutil -m cp -r gs://neurogen-spring22-data/Assignment3/* data/")
```
...
1.  We are considering each cell a biological replicate. This is incorrect at best and fraudulent at worst. We know by the design of our experiment that the replicates are mice, not cells, and that our *n* is 3, not 1500.
